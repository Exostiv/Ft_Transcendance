...
render() {
  return (
    <div>
      <canvas ref="canvas" width={gameWidth} height={gameHeight} id="gameCanvas" />
      <div className="buttons buttonLeft">W</div>
      <div className="buttons buttonLeft" id="buttonS">
        S
      </div>
      <div className="buttons buttonRight" id="buttonUp">
        Up
      </div>
      <div className="buttons buttonRight">Down</div>
      <button className="buttons" id="butt1">
        vs Computer
      </button>
      <button className="buttons" id="butt2">
        2 Players
      </button>
    </div>
  );
